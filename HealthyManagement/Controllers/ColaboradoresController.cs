...
namespace HealthyManagement.Controllers
{
    public class ColaboradoresController : Controller
    {
        ...
        public ColaboradoresController(HealthyManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CPF,Telefone")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CPF,Telefone")] Colaborador colaborador)
        {
